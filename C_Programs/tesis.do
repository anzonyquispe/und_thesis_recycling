...
*** Working with general information about households. Extracting capacitation and recycling
	...
	keep  CCDD CCPP CCDI CONGLOMERADO NSELV VIVIENDA HOGAR AREA P175A P175D NOMBREDD
...
*** Cleaning data
	...
	replace education = "6 Sup Uni Comp" 		if education ==  	"8"
	replace education = "7 Pregrado Incom" 		if education ==  	"9"
	replace education = "8 Pregrado" 			if education == 	"10"
...
s
*** Making estimations
	logit recycle capacitation size_fam age sex ib5.ESTRATO  ib8.education
	est store model_edu_label
	margins, dydx( capacitation size_fam age sex ib5.ESTRATO  ib8.education ) post
	...
	logit recycle capacitation size_fam age sex ib5.ESTRATO edyears
	est store model_edu_year
	margins, dydx( capacitation size_fam age sex ib5.ESTRATO edyears ) post
	...
	*** Tables written for MS-Word
	...
	esttab 	model_edu_label margin_edu_label model_edu_year margin_edu_year  using "${tables}/table_1.rtf", replace		 ///
			...
			varlabels(capacitation "Capacitación" 1.ESTRATO "A" 2.ESTRATO "B" 3.ESTRATO "C" 4.ESTRATO "D"  ///
						...
						8.education "Univ. Incom." 9.education "Univ. Com." 10.education "Postgrado" edyears "Años de educacion") ///
			...
			unicode convertfile "${tables}/table_1.rtf" "${tables}/table_3.rtf", dstencoding( ISO-8859-1 ) replace
	...
	esttab 	model_max_edu_label margin_max_edu_label model_max_edu_year margin_max_edu_year using "${tables}/table_2.rtf", replace		 ///
			...
			unicode convertfile "${tables}/table_2.rtf" "${tables}/table_4.rtf", dstencoding( ISO-8859-1 ) replace
